...
function Modules() {
  ...
  const modules = [
    ...
    },
    {
      ...
      stages: [
        "Статичное видео (Машина)",
        "Динамичное видео (Машина)",
        "Эффект робота (Машина)",
        "Динамичное видео (Модель)",
        "Динамичное видео (Микро объекты)",
      ],
      desc: null,
    },
    {
      id: 4,
      name: "Модуль 4. Монтаж",
      stages: [
        "Начало монатажа (музыка)",
        "Трекинг",
        "Статика",
        "Динамика (Машина)",
        "Робот (Машина)",
        "Динамика (Модель)",
        "Динамика (Микро объекты)",
        "Спидрамп",
      ],
      desc: null,
    },
